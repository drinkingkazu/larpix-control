...
_property_configuration = OrderedDict([
        ...
        ('enable_tx_dynamic_powerdown',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl'], (int, bool), 0, 1), (984, 985))),
        ('load_config_defaults',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl'], (int, bool), 0, 1), (985, 986))),
        ('enable_fifo_diagnostics',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl'], (int, bool), 0, 1), (986, 987))),
        ('clk_ctrl',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl'], (int, bool), 0, 3), (987, 989))),
        #('enable_tx_dynamic_powerdown',
